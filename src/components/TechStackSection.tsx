  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8">
        ...
        <rect x="5" y="12" width="4" height="5" rx="1" />
      </svg>
    ),
  },
  {
...
export default function TechStackSection() {
  ...
  return (
    <section id="techstack" className="relative py-24 md:py-32 bg-zinc-950 overflow-hidden">
      {/* Top border gradient */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-9 gap-4 md:gap-6">
          {techStack.map((tech, i) => (
            ...
            >
              <div
                className="w-14 h-14 md:w-16 md:h-16 rounded-2xl flex items-center justify-center glass border border-white/5 group-hover:border-opacity-40 transition-all duration-300"
                style={{
                  color: tech.color,
                }}
              >
              ...
              <span className="text-zinc-500 text-xs text-center font-mono-custom leading-tight group-hover:text-zinc-300 transition-colors">
                {tech.name}
              </span>
            </motion.div>
          ))}
